...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxe0f6709bf5559eb4',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '9d060249fbd3c51e414574fb762f7622',
  ...
  LITERARY_PREFERENCE: "You had me at hello",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {
          type: '生日', name: '老婆', year: '2003', date: '07-04',
        },
        {
          type: '节日', name: '在一起一周年纪念日', year: '2022', date: '04-06',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '老公', year: '2003', date: '02-01',
        },
        {
          type: '节日', name: '第一次见面纪念日', year: '2022', date: '02-16',
        }
      ],
